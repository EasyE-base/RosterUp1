      ...
      <Container>
        <nav className="flex h-16 items-center justify-between">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-8">
            ...
            <Link href="/pricing" prefetch={false} className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Pricing
            </Link>

            <Link href="/resources" prefetch={false} className="text-sm font-medium text-gray-300 hover:text-white transition-colors">
              Resources
            </Link>
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-4">
            ...
            <Button className="bg-blue-600 hover:bg-blue-700" asChild>
              <Link href="/auth/signup" prefetch={false}>Join Us</Link>
            </Button>
          </div>
